...
[![Google Cloud Platform](https://img.shields.io/badge/GCP-4285F4?style=for-the-badge&logo=google-cloud&logoColor=white)](https://cloud.google.com/)
...
- [**WebApp**](https://github.com/ashutoxh-org/webapp): Spring Boot-based RESTful service for user management with PostgreSQL.

- [**Terraform**](https://github.com/ashutoxh-org/tf-gcp-infra): Terraform code to provision and manage the GCP infrastructure.

- [**Serverless**](https://github.com/ashutoxh-org/serverless): Google Cloud Functions for event-driven processes like email verification.
